...
// Activity feed: bisa berupa timeline log dari modLogs user
type ActivityItem = {
  id: number;
  projectName?: string;
  logName?: string;
...
// Helper: format tanggal dengan aman, hindari "Invalid Date"
...
export default function DashboardPage() {
  ...
  // Helper: ambil nama aktivitas dari berbagai kemungkinan field backend
            ...
            <div className="flex-1 px-8 pb-12 pt-6">
              ...
              <div className="mb-8">
                ...
                <p className="text-muted-foreground text-sm mt-0.5">
                  Here&apos;s an overview of your build projects
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-card border border-border rounded-xl p-5 flex flex-col justify-between">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">aktivitas modifikasi terbaru</p>
                  </div>
                </div>
              </div>
              ...
              {/* ACTIVITY FEED — data per user, no Invalid Date */}
              <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-5">
                  <Clock className="text-green-500" size={18} />
                  <h2 className="text-base font-bold tracking-tight">Recent Activity Feed</h2>
                </div>
